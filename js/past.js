document.addEventListener("DOMContentLoaded", function () {
  ...
  let currentDate = null; // Variable para almacenar la fecha actual
  ...
  fetchDataFromAPI()
    .then((apiData) => {
      ...
      function filterEvents() {
        ...
        currentDate = new Date(data.currentDate); // Establecer la fecha actual

        const pastEvents = apiData.events.filter((event) => {
  ...
  // Resto del código relacionado con la página
});
